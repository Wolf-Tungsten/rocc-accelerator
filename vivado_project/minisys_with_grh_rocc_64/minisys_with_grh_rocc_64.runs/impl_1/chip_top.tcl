...
set rc [catch {
  ...
  add_files -quiet /home/wolf/rocket-chip/rocc-accelerator/vivado_project/minisys_with_grh_rocc_64/minisys_with_grh_rocc_64.runs/synth_1/chip_top.dcp
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force chip_top_physopt.dcp
