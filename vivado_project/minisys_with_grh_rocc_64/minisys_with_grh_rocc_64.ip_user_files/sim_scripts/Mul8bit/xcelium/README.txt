...
#
# Generated by export_simulation on Sat May 16 20:29:13 CST 2020
#
################################################################################
...
'-reset_run' switch to the './Mul8bit.sh' script.

./Mul8bit.sh -reset_run
...
./Mul8bit.sh -noclean_files

For more information on the script, please type './Mul8bit.sh -help'.
